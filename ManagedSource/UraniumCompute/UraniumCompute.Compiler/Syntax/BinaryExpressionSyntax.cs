...
internal class BinaryExpressionSyntax : ExpressionSyntax
{
    ...
    static BinaryExpressionSyntax()
    {
        definedOperations = new HashSet<BinaryOperationDesc>
        {
            ...
            new(typeof(int), typeof(int), BinaryOperationKind.And, typeof(int)),
            new(typeof(uint), typeof(uint), BinaryOperationKind.And, typeof(uint)),
            new(typeof(int), typeof(int), BinaryOperationKind.Or, typeof(int)),
            new(typeof(uint), typeof(uint), BinaryOperationKind.Or, typeof(uint)),
            new(typeof(int), typeof(int), BinaryOperationKind.Xor, typeof(int)),
            new(typeof(uint), typeof(uint), BinaryOperationKind.Xor, typeof(uint)),
            ...
            new(typeof(int), typeof(uint), BinaryOperationKind.And, typeof(int)),
            new(typeof(int), typeof(uint), BinaryOperationKind.Or, typeof(int)),
            new(typeof(int), typeof(uint), BinaryOperationKind.Xor, typeof(int)),
            ...
            new(typeof(uint), typeof(int), BinaryOperationKind.And, typeof(int)),
            new(typeof(uint), typeof(int), BinaryOperationKind.Or, typeof(int)),
            new(typeof(uint), typeof(int), BinaryOperationKind.Xor, typeof(int)),
